...
let
  # Path to the secret file managed outside of the Nix store
  authFile = "/etc/nginx_king-joe.secret";
in
{
          ...
          root = pkgs.writeTextDir "index.html" ''
            ...
            <body>
              ...
              <div class="grid">
                ...
                <a href="https://jupyter.campgroundlabs.xyz/" class="card">
                  <h3>🪐 JupyterHub</h3>
                  <p>Interactive python computing environment.</p>
                </a>
              </div>
            </body>
            </html>
